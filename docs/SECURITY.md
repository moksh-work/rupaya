...
CertificatePinner.Builder()
    .add("api.rupaya.in", "sha256/PUBLIC_KEY_HASH")
    .build()
```
...
**Security Team:**
- Email: security@rupaya.in
- PGP Key: Available at https://rupaya.in/security.asc
...
- Privacy policy: https://rupaya.in/privacy
